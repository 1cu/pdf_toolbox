...
from pdf_toolbox.actions.images import DpiChoice, QualityChoice, pdf_to_images, resolve_image_settings
...
def _export_pdf(
    pdf_path: Path,
    *,
    export_profile: ProfileChoice,
    image_format: ImageFormatChoice,
    dpi: int | DpiChoice,
    quality: int | QualityChoice,
    out_dir: str | None,
    pages: str | None,
    cancel: Event | None,
) -> list[str]:
    """Export a PDF file using the requested profile."""
