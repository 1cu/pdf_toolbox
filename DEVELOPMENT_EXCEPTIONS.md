...
| ------------------------------------------------ | ---------------------------- | --------------------------------------------------------------------- | -------- |
| src/pdf_toolbox/actions/ocr.py:71                | PLR0913                      | public API keeps parameter parity                                     | -        |
| src/pdf_toolbox/actions/ocr.py:161               | type: ignore[attr-defined]   | pymupdf stubs lack extract_image                                      | -        |
| src/pdf_toolbox/actions/ocr.py:182               | PLC0415                      | defer pytesseract import until needed                                 | -        |
| src/pdf_toolbox/actions/ocr.py:192               | PLC0415                      | defer pytesseract import until needed                                 | -        |
