...
| scripts/pin_actions.py:65                        | S310                                     | validated HTTPS request to GitHub API                                 | -        |
| scripts/pin_actions.py:69                        | S310, B310                               | GitHub API requests rely on urllib with pinned CA bundle              | -        |
| scripts/pin_actions.py:74                        | pragma: no cover                         | log and rethrow network errors for diagnostics                        | -        |
