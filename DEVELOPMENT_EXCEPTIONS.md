...
| src/pdf_toolbox/renderers/http_office.py:183     | BLE001, RUF100                           | renderer initialisation may fail for arbitrary config data; degrade to unavailable | -        |
| src/pdf_toolbox/renderers/http_office.py:341     | PLR0913                                  | renderer API requires many parameters                                              | -        |
...
| src/pdf_toolbox/renderers/registry.py:207        | BLE001, RUF100                           | renderer constructors may fail arbitrarily; treat as unavailable                   | -        |
| src/pdf_toolbox/renderers/registry.py:232        | BLE001, RUF100                           | plugin can_handle implementations may fail; treat as unavailable                   | -        |
| src/pdf_toolbox/renderers/registry.py:239        | BLE001, RUF100                           | plugin can_handle implementations may fail; treat as unavailable                   | -        |
