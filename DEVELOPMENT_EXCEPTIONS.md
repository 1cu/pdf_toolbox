...
| src/pdf_toolbox/renderers/\_http_util.py:25      | pragma: no cover                         | renderer checks dependency availability before calling helper | -        |
| src/pdf_toolbox/renderers/\_http_util.py:29      | type: ignore[no-untyped-call]            | requests call lacks typing information                        | -        |
...
| src/pdf_toolbox/renderers/http_office.py:28      | pragma: no cover                         | branch only aids type checking when dependency missing        | -        |
| src/pdf_toolbox/renderers/http_office.py:177     | pragma: no cover                         | defensive guard against unexpected config state               | -        |
| src/pdf_toolbox/renderers/http_office.py:313     | PLR0913                                  | renderer API requires many parameters                         | -        |
...
| tests/renderers/test_http_office.py:191          | type: ignore[import-untyped]             | requests library does not ship type information               | -        |
| tests/renderers/test_http_office.py:217          | type: ignore[import-untyped]             | requests library does not ship type information               | -        |
| tests/renderers/test_http_office.py:449          | type: ignore[import-untyped]             | requests library does not ship type information               | -        |
