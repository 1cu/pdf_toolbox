...
| src/pdf_toolbox/renderers/\_requests.py:11       | pragma: no cover             | optional dependency import guard exercised via unit tests             | -        |
| src/pdf_toolbox/renderers/\_requests.py:13       | pragma: no cover             | gracefully handle missing optional dependency                         | -        |
