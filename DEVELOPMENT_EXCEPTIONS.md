...
| src/pdf_toolbox/renderers/http_office.py:171     | pragma: no cover                         | defensive guard against unexpected config state                 | -        |
| src/pdf_toolbox/renderers/http_office.py:192     | PLR0915                                  | method orchestrates HTTP upload and error mapping               | -        |
| src/pdf_toolbox/renderers/http_office.py:305     | PLR0913                                  | renderer API requires many parameters                           | -        |
...
| src/pdf_toolbox/renderers/pptx.py:58             | PLR0913                                  | renderer API requires many parameters                           | -        |
| src/pdf_toolbox/renderers/pptx_base.py:16        | PLR0913                                  | renderer API requires many parameters                           | -        |
| src/pdf_toolbox/renderers/registry.py:79         | PLR0912                                  | handles diverse entry point backends and failure modes          | -        |
| src/pdf_toolbox/renderers/registry.py:87         | pragma: no cover                         | entry point discovery may fail when metadata backend is absent  | -        |
| src/pdf_toolbox/renderers/registry.py:96         | pragma: no cover                         | compatibility shim for older importlib.metadata implementations | -        |
| src/pdf_toolbox/renderers/registry.py:103        | pragma: no cover                         | plugin entry point import may fail due to third-party issues    | -        |
| src/pdf_toolbox/renderers/registry.py:121        | pragma: no cover                         | entry point may reference unavailable module                    | -        |
| src/pdf_toolbox/renderers/registry.py:158        | pragma: no cover                         | builtin providers may be unavailable on this platform           | -        |
| src/pdf_toolbox/renderers/registry.py:179        | PLR0911                                  | evaluation flow returns early for availability outcomes         | -        |
| src/pdf_toolbox/utils.py:13                      | type: ignore                             | PyMuPDF lacks type hints                                        | -        |
| tests/conftest.py:3                              | type: ignore                             | PyMuPDF lacks type hints                                        | -        |
| tests/renderers/test_http_office.py:197          | type: ignore[import-untyped]             | requests library does not ship type information                 | -        |
| tests/renderers/test_http_office.py:224          | type: ignore[import-untyped]             | requests library does not ship type information                 | -        |
| tests/renderers/test_http_office.py:457          | type: ignore[import-untyped]             | requests library does not ship type information                 | -        |
