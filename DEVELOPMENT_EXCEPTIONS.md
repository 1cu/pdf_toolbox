...
| tests/gui/test_main_window.py:534                | type: ignore[assignment]     | stub worker lacks QObject base class                                  | -        |
| tests/gui/test_main_window.py:642                | N802                         | mimic Qt worker API naming                                            | -        |
| tests/gui/test_main_window.py:652                | type: ignore[assignment]     | stub worker lacks QObject base class                                  | -        |
| tests/gui/test_main_window.py:730                | type: ignore[override]       | stub implements abstract renderer for tests                           | -        |
| tests/gui/test_main_window.py:734                | type: ignore[override]       | stub implements abstract renderer for tests                           | -        |
| tests/gui/test_main_window.py:1216               | type: ignore[no-untyped-def] | Worker injects Event parameter dynamically                            | -        |
| tests/gui/test_smoke_boot.py:16                  | pragma: no cover             | skip smoke test when PySide6 missing                                  | -        |
| tests/gui/test_widgets.py:15                     | pragma: no cover             | skip widget tests when PySide6 missing                                | -        |
| tests/gui/test_widgets.py:133                    | N802                         | stub mirrors Qt URL API                                               | -        |
| tests/gui/test_widgets.py:140                    | N802                         | stub mirrors Qt MIME API                                              | -        |
| tests/gui/test_widgets.py:151                    | N802                         | stub mirrors Qt event API                                             | -        |
| tests/gui/test_widgets.py:154                    | N802                         | stub mirrors Qt event API                                             | -        |
| tests/gui/test_widgets.py:196                    | N802                         | stub mirrors Qt URL API                                               | -        |
| tests/gui/test_widgets.py:203                    | N802                         | stub mirrors Qt MIME API                                              | -        |
| tests/gui/test_widgets.py:213                    | N802                         | stub mirrors Qt event API                                             | -        |
| tests/gui/test_worker.py:11                      | pragma: no cover             | skip worker tests when PySide6 missing                                | -        |
| tests/gui/test_worker.py:43                      | type: ignore[no-untyped-def] | Worker injects Event parameter dynamically                            | -        |
