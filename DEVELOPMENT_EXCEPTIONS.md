...
| scripts/pin_actions.py:56                        | S310, B310                               | GitHub API requests rely on urllib with pinned CA bundle              | -        |
| scripts/pin_actions.py:61                        | pragma: no cover                         | log and rethrow network errors for diagnostics                        | -        |
